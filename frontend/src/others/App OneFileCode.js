...
function App() {
  ...
  function handleAddEntry() {
    ...
    axios
      .post('http://localhost:8080/goal/' + selectedGoal.goalId + '/entries', {
  ...
  function handleDeleteEntry(entryId) {
    ...
    axios
      .delete('http://localhost:8080/entries/' + entryId)
      .then(function () {
  ...
  function handleDeleteGoal(goalId) {
    axios.delete('http://localhost:8080/goals/' + goalId).then(function () {
  ...
  function handleRenameGoal(goalId) {
    ...
    axios
      .put('http://localhost:8080/goals/' + goalId + '?newTitle=' + renameGoalTitle)
      .then(function (res) {
  ...
  function handleRenameEntry(entryId, currentDescription) {
    ...
    var newDescription = window.prompt('Enter new description:', currentDescription);
    ...
    axios
      .put('http://localhost:8080/entries/' + entryId, { description: newDescription })
      .then(function (res) {
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '20px auto' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <button onClick={handleAddGoal} style={{ marginTop: '8px' }}>
          Save Goal
        </button>
      </div>
              ...
              >
                ...
                <div style={{ marginTop: '10px' }}>
                  <input
                    ...
                    onChange={function (e) {
                      setRenameGoalTitle(e.target.value);
                    }}
      ...
      {selectedGoal && (
        ...
        >
          ...
          {(!selectedGoal.entries || selectedGoal.entries.length === 0) && <p>No entries yet.</p>}
                ...
                return (
                  <li key={entry.id}>
                    ...
                    <button
                      style={{ marginLeft: '8px' }}
                      onClick={function () {
                        handleRenameEntry(entry.id, entry.description);
                      }}
                    >
                      Rename
                    </button>
